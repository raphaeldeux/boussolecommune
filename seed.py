...
INDICATEURS = [
    ...
    # ─── Portrait démographique (INSEE RP) ────────────────────────────────────────
    {
        "id": "pop_total",
        "thematique": "portrait",
        "libelle_citoyen": "Combien d'habitants ?",
        "libelle_technique": "Population municipale",
        "unite": "hab",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": None, "libelle_reference": None,
        "description": "Population municipale au dernier recensement INSEE.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_evolution_10ans",
        "thematique": "portrait",
        "libelle_citoyen": "La commune est-elle en croissance ?",
        "libelle_technique": "Évolution de la population sur 10 ans",
        "unite": "%",
        "sens_positif": "haut",
        "seuil_vert": 5.0, "seuil_orange": 0.0, "seuil_rouge": -5.0,
        "valeur_reference": 3.5, "libelle_reference": "Moyenne nationale",
        "description": "Variation relative de la population entre le recensement N-10 et le plus récent.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_menages_solo",
        "thematique": "lien_social",
        "libelle_citoyen": "Combien de personnes vivent seules ?",
        "libelle_technique": "Part des ménages d'une personne",
        "unite": "%",
        "sens_positif": "bas",
        "seuil_vert": 25.0, "seuil_orange": 32.0, "seuil_rouge": 40.0,
        "valeur_reference": 36.0, "libelle_reference": "Moyenne nationale (RP 2020)",
        "description": "Part des ménages composés d'une seule personne. Indicateur d'isolement potentiel.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_taille_menages",
        "thematique": "portrait",
        "libelle_citoyen": "Quelle est la taille des foyers ?",
        "libelle_technique": "Taille moyenne des ménages",
        "unite": "pers/mén",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 2.2, "libelle_reference": "Moyenne nationale (RP 2020)",
    ...
    # ─── Logement (INSEE RP) ───────────────────────────────────────────────────────
    {
        ...
        "libelle_citoyen": "Y a-t-il beaucoup de logements vides ?",
        "libelle_technique": "Taux de logements vacants",
        "unite": "%",
        "sens_positif": "bas",
        "seuil_vert": 5.0, "seuil_orange": 8.0, "seuil_rouge": 12.0,
        "valeur_reference": 8.3, "libelle_reference": "Moyenne nationale (RP 2020)",
        "description": "Part des logements vacants parmi l'ensemble des logements.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "log_residences_secondaires_taux",
        "thematique": "portrait",
        "libelle_citoyen": "Part des résidences secondaires",
        "libelle_technique": "Part des résidences secondaires",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": None, "libelle_reference": None,
        "description": "Part des résidences secondaires et logements occasionnels parmi l'ensemble des logements.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "log_proprietaires_taux",
        "thematique": "portrait",
        "libelle_citoyen": "Combien de propriétaires ?",
        "libelle_technique": "Part des ménages propriétaires",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 57.7, "libelle_reference": "Moyenne nationale (RP 2020)",
        "description": "Part des ménages occupant leur résidence principale en tant que propriétaires.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "log_anciennete_avant1946",
        "thematique": "cadre_vie",
        "libelle_citoyen": "Part du parc construit avant 1946",
        "libelle_technique": "Part du parc construit avant 1946",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": None, "libelle_reference": None,
        "description": "Part des logements construits avant 1946 (patrimoine ancien, risque énergétique élevé).",
        "source_type": "api_insee_rp",
    },
    {
        "id": "log_anciennete_1946_1990",
        "thematique": "cadre_vie",
        "libelle_citoyen": "Part du parc construit entre 1946 et 1990",
        "libelle_technique": "Part du parc construit 1946–1990",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": None, "libelle_reference": None,
        "description": "Part des logements construits entre 1946 et 1990 (réhabilitation thermique prioritaire).",
        "source_type": "api_insee_rp",
    },
    {
        "id": "log_anciennete_post1990",
        "thematique": "cadre_vie",
        "libelle_citoyen": "Part du parc récent (après 1990)",
        "libelle_technique": "Part du parc construit après 1990",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": None, "libelle_reference": None,
        "description": "Part des logements construits après 1990 (parc récent, meilleures performances énergétiques).",
        "source_type": "api_insee_rp",
    },
    {
        "id": "eco_emplois_actifs_ratio",
        "thematique": "finances",
        "libelle_citoyen": "La commune offre-t-elle des emplois à ses habitants ?",
        "libelle_technique": "Rapport emplois sur commune / actifs résidents",
        "unite": "ratio",
        "sens_positif": "haut",
        "seuil_vert": 0.8, "seuil_orange": 0.5, "seuil_rouge": 0.3,
        "valeur_reference": 0.8, "libelle_reference": "Communes résidentielles équilibrées",
        "description": "Nombre d'emplois sur le territoire divisé par le nombre d'actifs résidents. Supérieur à 1 = commune créatrice d'emplois.",
        "source_type": "api_insee_rp",
    },
    # ─── Âges (INSEE RP via Melodi — alimentent aussi la pyramide) ────────────
    {
        "id": "pop_age_lt15",
        "thematique": "portrait",
        "libelle_citoyen": "Part des moins de 15 ans",
        "libelle_technique": "Part des moins de 15 ans",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 17.5, "libelle_reference": "Moyenne nationale (RP 2022)",
        "description": "Part de la population âgée de moins de 15 ans.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_age_15_24",
        "thematique": "portrait",
        "libelle_citoyen": "Part des 15–24 ans",
        "libelle_technique": "Part des 15–24 ans",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 11.9, "libelle_reference": "Moyenne nationale (RP 2022)",
        "description": "Part de la population âgée de 15 à 24 ans.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_age_25_39",
        "thematique": "portrait",
        "libelle_citoyen": "Part des 25–39 ans",
        "libelle_technique": "Part des 25–39 ans",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 18.4, "libelle_reference": "Moyenne nationale (RP 2022)",
        "description": "Part de la population âgée de 25 à 39 ans.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_age_40_54",
        "thematique": "portrait",
        "libelle_citoyen": "Part des 40–54 ans",
        "libelle_technique": "Part des 40–54 ans",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 19.4, "libelle_reference": "Moyenne nationale (RP 2022)",
        "description": "Part de la population âgée de 40 à 54 ans.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_age_55_64",
        "thematique": "portrait",
        "libelle_citoyen": "Part des 55–64 ans",
        "libelle_technique": "Part des 55–64 ans",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 13.3, "libelle_reference": "Moyenne nationale (RP 2022)",
        "description": "Part de la population âgée de 55 à 64 ans.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_age_65_79",
        "thematique": "portrait",
        "libelle_citoyen": "Part des 65–79 ans",
        "libelle_technique": "Part des 65–79 ans",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 13.0, "libelle_reference": "Moyenne nationale (RP 2022)",
        "description": "Part de la population âgée de 65 à 79 ans.",
        "source_type": "api_insee_rp",
    },
    {
        "id": "pop_age_ge80",
        "thematique": "portrait",
        "libelle_citoyen": "Part des 80 ans et plus",
        "libelle_technique": "Part des 80 ans et plus",
        "unite": "%",
        "sens_positif": "neutre",
        "seuil_vert": None, "seuil_orange": None, "seuil_rouge": None,
        "valeur_reference": 6.5, "libelle_reference": "Moyenne nationale (RP 2022)",
        "description": "Part de la population âgée de 80 ans et plus.",
        "source_type": "api_insee_rp",
    },
    {
